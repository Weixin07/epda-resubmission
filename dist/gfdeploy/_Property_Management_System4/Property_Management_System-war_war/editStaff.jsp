...
<script>
    document.title = "Edit Managing Staff Info";
...
function populateFormFields(row) {
      ...
      form.elements['stName'].value = cells[0].textContent;
      form.elements['stEmail'].value = cells[1].textContent;
      form.elements['stPass'].value = cells[2].textContent;
      form.elements['stAge'].value = cells[3].textContent;
      form.elements['stPhoneNo'].value = cells[4].textContent;
      form.elements['stAddress'].value = cells[5].textContent;
    }
...
function loadStaffTable() {
      fetch('LoadStaffTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('EditStaffTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="editStaffForm" action="EditStaff" method="POST">
        <h1>Edit Staff</h1>
