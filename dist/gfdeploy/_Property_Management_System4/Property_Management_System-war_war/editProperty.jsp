...
<script>
    document.title = "Edit Property Listing";
...
function populateFormFields(row) {
      ...
      form.elements['pPrice'].value = cells[2].textContent;
      form.elements['pAddress'].value = cells[3].textContent;
      form.elements['pType'].value = cells[4].textContent;
      form.elements['pSize'].value = cells[5].textContent;
      form.elements['pFurnish'].value = cells[6].textContent;
      form.elements['pBuild'].value = cells[7].textContent;
      form.elements['pDescription'].value = cells[8].textContent;
    }
...
<main>
  <div class="container">
    <form class="form-container" id="editPropertyForm" action="EditProperty" method="POST" enctype="multipart/form-data">
      <h1>Edit Property</h1>
      <input style="display:none;" type="number" name="pId"></input>
      <br>
