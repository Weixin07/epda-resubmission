...
<script>
    document.title = "Delete Buyer Info";
...
function populateFormFields(row) {
      ...
      const form = document.getElementById('deleteBuyerForm');
...
function loadBuyerTable() {
      fetch('LoadBuyerTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('ViewBuyerTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="deleteBuyerForm" action="DeleteBuyer" method="POST">
        <h1>Delete Buyer Info</h1>
        <input type="email" name="bEmail" placeholder="Email" readonly>
        <br>
        <input type="submit" value="Delete Buyer Info">
        <br>
