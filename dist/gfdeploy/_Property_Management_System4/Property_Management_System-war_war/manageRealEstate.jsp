...
<head>
    ...
    <script>
        function handleClick(quadrant) {
            switch (quadrant) {
                case 'A':
                    window.location.href = "createProperty.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'S':
                    window.location.href = "searchProperty.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'E':
                    window.location.href = "editProperty.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'D':
                    window.location.href = "deleteProperty.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
            }
        }
...
<body>
    ...
    <div id="quadrantC" class="quadrant" onmouseover="changeText('cText', 'Add')" onmouseout="changeText('cText', 'A')" onclick="handleClick('A')">
