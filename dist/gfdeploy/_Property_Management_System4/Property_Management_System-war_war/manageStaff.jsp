...
<head>
    ...
    <script>
        function handleClick(quadrant) {
            switch (quadrant) {
                case 'A':
                    window.location.href = "addStaff.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'S':
                    window.location.href = "searchStaff.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'E':
                    window.location.href = "editStaff.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
                case 'D':
                    window.location.href = "deleteStaff.jsp?uNameLabel2=" + encodeURIComponent(document.getElementById("uNameLabelText").textContent);
                    break;
            }
        }
