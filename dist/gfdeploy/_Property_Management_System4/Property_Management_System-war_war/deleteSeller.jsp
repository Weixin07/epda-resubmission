...
<script>
    document.title = "Delete Seller Info";
...
function populateFormFields(row) {
      ...
      const form = document.getElementById('deleteSellerForm');
...
function loadSellerTable() {
      fetch('LoadSellerTable')
        ...
        .then(data => {
          const propertyTableBody = document.getElementById('ViewSellerTableBody');
...
<main>
  <div class="container">
    <form class="form-container" id="deleteSellerForm" action="DeleteSeller" method="POST">
        <h1>Delete Seller Info</h1>
        <input type="email" name="sEmail" placeholder="Email" readonly>
        <br>
        <input type="submit" value="Delete Seller Info">
        <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="ViewSellerTableBody"w>
