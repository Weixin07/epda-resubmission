    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="EditSellerProfile" method="POST">
                <input type="text" name="sEditEmail" value="${uNameLabelText}" readonly>
                <br>
                <input type="text" name="sEditName" placeholder="Name" value="${nameLabelText}">
                <br>
                <input type="number" name="sEditAge" placeholder="Age" value="${ageLabelText}">
                <br>
                <select name="sEditGender">
                    <option value="" selected disabled hidden>Gender</option>
                    <option value="M">Male</option>
                    <option value="F">Female</option>
                </select>
                <br>
                <input type="text" name="sEditPhone" placeholder="Phone No." value="${phNoLabelText}">
                <br>
                <input type="text" name="sEditAddress" placeholder="Address" value="${addressLabelText}">
                <br>
                <input type="password" name="sEditCurrentPass" placeholder="Current Password">
                <br>
                <input type="password" name="sEditNewPass" placeholder="New Password">
                <br>
                <input type="password" name="sEditConfNewPass" placeholder="Confirm New Password">
                <br>
