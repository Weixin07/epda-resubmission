...
<script>
    document.title = "Search Managing Staff";
...
function loadStaffTable() {
    fetch('LoadStaffTable')
        ...
        .then(data => {
            const propertyTableBody = document.getElementById('staffViewTableBody');
...
<main>
  <div class="container">
    <form class="form-container" action="SearchStaff" method="POST">
      <h1>Search Staff</h1>
      <input type="text" name="searchStaff" placeholder="Search Staff Member">
      <br>
    ...
    <div class="property-listing">
      ...
      <table>
        ...
        <tbody id="staffViewTableBody" ${hideStaffTableLabel ? 'style="display:none;"' : ''}>
          <!-- Property data will be dynamically loaded here -->
                        
        </tbody>
        <tbody id="staffSearchTableBody" >
          <!-- Property data will be dynamically loaded here -->
                        <% List<Staff> filteredStaff = (List<Staff>) request.getAttribute("filteredStaff");
                           if (filteredStaff != null) {
                               for (Staff stf : filteredStaff) { %>
                                   <tr>
                                       <td><%= stf.getStName() %></td>
