...
function loadSellerTable() {
      fetch('LoadSellerApprovalTable')
        ...
        .catch(error => {
          console.error('Error loading Seller table:', error);
        });
...
<main>
  <div class="container">
    <form class="form-container" id="ApproveSellerForm" action="ApproveSeller" method="POST">
        <h1>Approve Seller</h1>
        <input type="text" name="sName" placeholder="Full Name" readonly>
            <br>
            <input type="email" name="sEmail" placeholder="Email" readonly>
            <br>
            <input type="password" name="sPass" placeholder="Password" readonly>
            <br>
            <input type="tel" name="sPhoneNo" placeholder="Phone Number (+60)" readonly> 
            <br>
            <input type="number" name="sAge" placeholder="Age" readonly>
            <br>
            ...
            <br>
            <input type="text" name="sAddress" placeholder="Address" readonly>
            <br>
            <input type="submit" value="Approve Seller">
            <br>
